...
export const MuseumConfig = {
  ...
  // Artefak utama di lobby
  lobbyArtifacts: [
    {
      x: 0,
      z: 6,
      rot: 0,
      title: "Tengkorak Iblis Purba",
      desc: "Replika tengkorak raksasa bertanduk yang menjadi centerpiece lobby utama.",
    },
  ],
